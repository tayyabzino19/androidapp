                            ...
                            <div class="row justify-content-center " style="background: #EEF0F8; ">
                                ...
                                <div class="col-lg-3 text-center" style="margin-top:20px; ">
                                    ...
                                    <div class="card-body  " style="background:#fff">
                                        ...
                                        <div class="image-input image-input-outline" id="userimage" @if ($user->photo == '') style="background-image: url(https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/600px-No_image_available.svg.png)"
                                    @else
                                                 style="background-image: url(' {{ asset('storage/user/' . $user->photo) }} ')" @endif>
                                    ...
                                    <div class="card-body  " style="background:#fff">
                                        ...
                                        <label>Auth Key</label>
                                            ...
                                            <div class="input-group">
                                                ...
                                                value="{{ $user->key }}" disabled>
                                                <div class="input-group-prepend">
                                                <span class="input-group-text">

                                                    {{-- <i class="flaticon-clipboard" data-clipboard="true" data-clipboard-target="#API" data-toggle="tooltip"
                                                        data-trigger="focus" data-html="true" title="Copy to Clip Board"></i>
                                                    </span> --}}
                                            </div>
